...
| Intra/inter prediction and compensation | partial | not-started | baseline 8x8 reference acquisition, luma/chroma intra modes, and single/bidirectional sample reconstruction; decoder integration, inter prediction, and motion compensation pending |
