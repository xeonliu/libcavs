...
| Intra/inter prediction and compensation | partial | partial | baseline 8x8 intra path, chroma bilinear interpolation at 1/8 and 1/16 precision, edge replacement, and single/bidirectional reconstruction; luma interpolation, motion-vector derivation, and decoder integration pending |
